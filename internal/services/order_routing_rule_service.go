...
type OrderRoutingRuleServiceInterface interface {
	...
	Update(ctx context.Context, id uint64, d dto.UpdateOrderRoutingRuleDTO, rawBody []byte) (*dto.OrderRoutingRuleResponseDTO, error)
	Delete(ctx context.Context, id uint64) error
	GetByID(ctx context.Context, id uint64) (*dto.OrderRoutingRuleResponseDTO, error)
...
// === UPDATE ===
func (s *OrderRoutingRuleService) Update(ctx context.Context, id uint64, d dto.UpdateOrderRoutingRuleDTO, rawBody []byte) (*dto.OrderRoutingRuleResponseDTO, error) {
	authContext, err := buildRuleAuthzContext(ctx, s.userRepo)
...
func (s *OrderRoutingRuleService) GetByID(ctx context.Context, id uint64) (*dto.OrderRoutingRuleResponseDTO, error) {
	authContext, err := buildRuleAuthzContext(ctx, s.userRepo)
	if err != nil || !authz.CanDo(authz.OrderRuleView, *authContext) {
		return nil, apperrors.ErrForbidden
	}
...
func (s *OrderRoutingRuleService) Delete(ctx context.Context, id uint64) error {
	authContext, err := buildRuleAuthzContext(ctx, s.userRepo)
	if err != nil || !authz.CanDo(authz.OrderRuleDelete, *authContext) {
